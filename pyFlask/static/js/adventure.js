...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Inject disclaimer popup once
  if (!sessionStorage.getItem("seenDisclaimer")) {
    ...
    popup.innerHTML = `
      <div>
        <p style="max-width: 400px;">⚠️ This site is currently under construction. You may encounter bugs or unfinished features. Enjoy your quest and keep coming back to see the changes!</p>
        <button onclick="document.getElementById('disclaimer-popup').remove()" 
          style="margin-top: 1rem; padding: 10px; font-size: 12px;">Got it!</button>
      </div>
    `;
